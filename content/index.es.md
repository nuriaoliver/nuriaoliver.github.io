...
<section class="home-intro" aria-labelledby="home-title">
	<div class="home-intro__content">
		<p class="home-eyebrow">Científica informática · Inteligencia artificial centrada en las personas</p>
	...
	<figure class="home-portrait">
		<img src="/bio/NuriaOliverFaceShotBlue.jpg" alt="Retrato de Nuria Oliver">
	</figure>
</section>
...
<section class="home-section" aria-labelledby="research-title">
	...
	<div class="home-research">
		<div>
			...
			<p>Modelos computacionales del comportamiento humano individual y colectivo, datos móviles e inteligencia artificial para el bien social.</p>
		</div>
		<div>
			<h3>Colaborar con la IA</h3>
			<p>Interacción persona-IA, interfaces inteligentes, IA educativa y sistemas que refuerzan el pensamiento crítico y la autonomía humana.</p>
		</div>
		<div>
			<h3>IA responsable</h3>
			<p>Equidad algorítmica, privacidad, transparencia, interpretabilidad e impacto social de la inteligencia artificial generativa.</p>
		</div>
	</div>
	<p class="home-section__link"><a href="/projects/">Explorar proyectos de investigación</a></p>
</section>
...
<section class="home-section home-credentials" aria-labelledby="credentials-title">
	...
	<nav class="home-external" aria-label="Perfiles externos">
		...
		<a href="https://scholar.google.com/citations?user=VJlCMGYAAAAJ&amp;hl=es">Google Scholar</a>
		<a href="https://es.wikipedia.org/wiki/Nuria_Oliver">Wikipedia</a>
		<a href="/papers/nuria-oliver-thesis.pdf">Tesis doctoral</a>
	</nav>
</section>
